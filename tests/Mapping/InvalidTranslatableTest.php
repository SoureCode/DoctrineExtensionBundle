...
use App\Entity\InvalidTranslatable;
...
class InvalidTranslatableTest extends KernelTestCase
{
    ...
    public function testGenerate(): void
    {
        ...
        $this->expectExceptionMessage(\sprintf('Class "%s" cannot be used as translation class for itself.', InvalidTranslatable::class));

        $this->setUpDatabase([
            InvalidTranslatable::class,
        ]);
    }
}
