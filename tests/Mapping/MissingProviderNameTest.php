...
use App\Entity\MissingProviderName;
...
class MissingProviderNameTest extends KernelTestCase
{
    ...
    public function testGenerate(): void
    {
        ...
        $this->expectExceptionMessage('Provider is required if type is not a automatically resolvable type (e.g. DateTime, UserInterface).');

        $this->setUpDatabase([
            MissingProviderName::class,
        ]);
    }
}
