...
final class UTCDateImmutableType extends DateImmutableType
{
    ...
    {
        return DateTimeHelper::convertToImmutablePHPValue($value, self::class, $platform->getDateFormatString());
    }
}
